"""predicting_urban_water_quality URL Configuration
...
from predicting_urban_water_quality import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Water_Quality/$', remoteuser.Predict_Water_Quality, name="Predict_Water_Quality"),
    ...
    url(r'^Find_Water_Quality_Predicted_Ratio/$', serviceprovider.Find_Water_Quality_Predicted_Ratio, name="Find_Water_Quality_Predicted_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Water_Quality/$', serviceprovider.View_Predicted_Water_Quality, name="View_Predicted_Water_Quality"),
