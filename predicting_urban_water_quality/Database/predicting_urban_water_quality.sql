...
--
-- Host: localhost
-- Generation Time: Jul 21, 2022 at 01:32 PM
...
--
-- Database: `predicting_urban_water_quality`
--
CREATE DATABASE IF NOT EXISTS `predicting_urban_water_quality` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_urban_water_quality`;
...
('3lvdz80x92jxbcubq8e83atxq5v6fg2n', 'eyJ1c2VyaWQiOjF9:1o1NA8:9cTg1X_HJGqR2yQvXaewIrCfCNSyh6Om6z6MDd1tC5w', '2022-06-29 07:10:00.345832'),
('3n8yk8qg2u90lo3ialn8n89ill0kdv15', 'eyJ1c2VyaWQiOjJ9:1oEVfb:J_BELgszCG7sH81cqm9czwrvHWEaV--PzK4oNIQQzNA', '2022-08-04 12:52:47.069262'),
...
('tjltuhsnoh0reuhf11pd0ob1fxhbpxvf', 'eyJ1c2VyaWQiOjN9:1oEW7C:GIr8fadWAeY06Rb8cC6L5jbyCS4FRJ96V-T8VJ9cmPQ', '2022-08-04 13:21:18.713978'),
...
('vt0uizhymiaq2fo78dmu7kwb7kky06mu', 'eyJ1c2VyaWQiOjF9:1o1Mc5:TCIfbmnPNgwGBMRM88nGQT4-ElIo9eLZN9XQz9PIssQ', '2022-06-29 06:34:49.825747'),
...
(1, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Vijayanagar', 'Male'),
(2, 'Kiran', 'Kiran123@gmail.com', 'Kiran', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(3, 'Ashok', 'Ashok123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Viajaynagar', 'Male');
...
(43, 'Naive Bayes', '77.02044790652386'),
(44, 'SVM', '78.97049922366378'),
(45, 'Logistic Regression', '74.8309166030685'),
(46, 'Naive Bayes', '76.97044659069977'),
(47, 'SVM', '78.89418142582699'),
(48, 'Logistic Regression', '74.5651201347404'),
(49, 'Naive Bayes', '76.99676307271244'),
(50, 'SVM', '78.89418142582699'),
(51, 'Logistic Regression', '75.06250164478013');
...
(32, 'Salinity', '33.33333333333333'),
(33, 'Fluoride', '16.666666666666664'),
(34, 'Iron', '33.33333333333333'),
(35, 'Arsenic-Fully Polluted', '16.666666666666664');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_water_quality_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_water_quality_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `State_Name` varchar(3000) NOT NULL,
  `District_Name` varchar(3000) NOT NULL,
  `Block_Name` varchar(3000) NOT NULL,
  `Panchayat_Name` varchar(3000) NOT NULL,
  `Village_Name` varchar(3000) NOT NULL,
  `Habitation_Name` varchar(3000) NOT NULL,
  `Year` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;

--
-- Dumping data for table `remote_user_water_quality_type`
--

INSERT INTO `remote_user_water_quality_type` (`id`, `State_Name`, `District_Name`, `Block_Name`, `Panchayat_Name`, `Village_Name`, `Habitation_Name`, `Year`, `Prediction`) VALUES
(1, 'ANDHRA PRADESH', 'EAST GODAVARI(04)', 'PRATHIPADU(10)', 'GOKAVARAM(04)', 'VANTHADA(014 )', '[''VANTHADA(0404410014010400)'']', '01-04-2020', 'Salinity'),
(2, 'ANDHRA PRADESH', 'PRAKASAM(08)', 'PULLALACHERUVU(02)', 'PULLALACHERUVU(04)', 'GARAPENTA(002 )', '[''GARAPENTA(0812102002010400)'']', '01-04-2020', 'Fluoride'),
(6, 'ASSAM', 'BARPETA', 'RUPSI PT.', 'BONGHUGI', 'KHATARTARI', '[''KHATARTARI(01004290200117001)'']', '01-04-2020', 'Iron'),
(7, 'WEST BENGAL', 'NORTH 24 PARAGANAS', 'BASIRHAT-I', 'ITINDA PANITAR', 'PANITAR', '[''GHOJHADANGA DAKSHINPARA'']', '01-04-2012', 'Arsenic-Fully Polluted'),
(8, 'ASSAM', 'JORHAT', 'JORHAT', 'PUB -THENGAL   G.P.', 'BOJAL BARI GAON', '[''BAJALBARI MAJOR CHUCK'']', '01-04-2011', 'Iron'),
(9, 'ANDHRA PRADESH', 'EAST GODAVARI(04)', 'RAMACHANDRAPURAM(39)', 'ODURU(05)', 'ODURU(005 )', '[''JUVVIPADU(0405139005020500)'']', '01-04-2020', 'Salinity');
